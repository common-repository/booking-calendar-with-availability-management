...
add_action('widgets_init', function() {return register_widget("idoSellBookingWidget");});

add_action('widgets_init', function() {return register_widget("idoSellBookingSideButtonWidget");});
